...
int32_t nrf24l01p_default_setup(const struct nrf24l01p * const device)
{
    ...
    const struct configuration {
        ...
        {NRF24L01P_REG_CONFIG,      CONFIG_MASK_RX_DR | CONFIG_MASK_TX_DS | CONFIG_MASK_TX_DS | CONFIG_PRIM_RX},
        {NRF24L01P_REG_EN_AA,       0x00},
        {NRF24L01P_REG_EN_RXADDR,   EN_RXADDR_ERX_P1 | EN_RXADDR_ERX_P1},
...
{
    int32_t ret;
    uint8_t fifo_st, data_to_read[33];
    const uint8_t opcode = 0b01100001;
